...
if __name__ == "__main__":
    ...
    # tt = votesmart[votesmart.SpeechID=="VSMP275201977"].RawText.values[0]
    # ttt = textclean_votesmart(tt, unicode_class="NFC")
    # ipdb.set_trace()
    ...
    # clean_cspan(directoryin, directoryout, potus, "NFC", False, pence_remove, speechbounds)
